...
(function () {
    ...
    function z(a, b, c) {
        var d, e;
        if (la(b))t(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b)); else if (t(b) && X(b))for (d in b)a.setAttribute(d, b[d]);
        return e
    }
    ...
    function Q(a, b, c, d, e) {
        a = C.createElement(a);
        b && r(a, b);
        e && H(a, {padding: 0, border: R, margin: 0});
        c && H(a, c);
        d && d.appendChild(a);
        return a
    }
    ...
    function Ob(a, b, c, d) {
        ...
        e.push(k);
        e.info = r(a, {higherRanks: f, totalRange: b * j});
        return e
    }
    ...
    var x, C = document, K = window, J = Math, s = J.round, T = J.floor, wa = J.ceil, y = J.max, O = J.min, L = J.abs, V = J.cos, Y = J.sin, xa = J.PI, ab = xa * 2 / 360, Fa = navigator.userAgent, Ib = K.opera, Ca = /msie/i.test(Fa) && !Ib, Qa = C.documentMode === 8, tb = /AppleWebKit/.test(Fa), bb = /Firefox/.test(Fa), pa = "http://www.w3.org/2000/svg", Z = !!C.createElementNS && !!C.createElementNS(pa, "svg").createSVGRect, Pb = bb && parseInt(Fa.split("Firefox/")[1],
            10) < 4, U = !Z && !Ca && !!C.createElement("canvas").getContext, Ra, fa = C.documentElement.ontouchstart !== x, Jb = {}, ub = 0, Za, M, cb, Oa, vb, B, ya = function () {
    }, ia = "div", R = "none", wb = "rgba(192,192,192," + (Z ? 1.0E-6 : 0.0020) + ")", zb = "millisecond", ib = "second", Ua = "minute", Ja = "hour", oa = "day", Va = "week", Ka = "month", ta = "year", Ya, jb, kb, mb, La, Wa, Xa, Ab, Bb, lb, Cb, Db, $ = {};
    K.Highcharts = {};
    cb = function (a, b, c) {
    ...
    var db = G.adapterRun, Qb = G.getScript, Rb = G.inArray, n = G.each, Kb = G.grep, Sb = G.offset, Sa = G.map, A = G.merge, I = G.addEvent, S = G.removeEvent, E = G.fireEvent, Lb = G.washMouseEvent, xb = G.animate, eb = G.stop, G = {
        ...
        x: 0,
        y: 15,
        style: {color: "#666", fontSize: "11px", lineHeight: "14px"}
    };
    M = {
        ...
        legend: {
            ...
            borderColor: "#909090",
            borderRadius: 5,
            navigation: {activeColor: "#3E576F", inactiveColor: "#CCC"},
            shadow: !1,
            itemStyle: {cursor: "pointer", color: "#3E576F", fontSize: "12px"},
        ...
        init: function (a, b) {
            ...
            if (la(a))c = a, h === "circle" ? c = {
                ...
                if (c === "d")d && d.join && (d = d.join(" ")), /(NaN| {2}|^$)/.test(d) && (d = "M 0 0"); else if (c === "x" && h === "text") {
                    ...
                    x: "cx",
                    y: "cy"
                }[c] || c; else if (h === "rect" && c === "r")z(g, {
                    rx: d,
                    ry: d
                }), j = !0; else if (c === "translateX" || c === "translateY" || c === "rotation" || c === "verticalAlign")j = p = !0; else if (c === "stroke")d = i.color(d, g, c); else if (c === "dashstyle")if (c = "stroke-dasharray", d = d && d.toLowerCase(), d === "solid")d = R; else {
                    if (d) {
                ...
                } else if (c === "isTracker")this[c] = d; else if (c === "width")d = w(d); else if (c === "align")c = "text-anchor", d = {
                    left: "start",
                    center: "middle",
                    right: "end"
                }[d]; else if (c === "title")e = g.getElementsByTagName("title")[0], e || (e = C.createElementNS(pa, "title"), g.appendChild(e)), e.textContent =
                    d;
            ...
            U && b && delete a.width;
            if (Ca && !Z)b && delete a.width, H(this.element, a); else {
        ...
        on: function (a, b) {
            ...
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    if (aa !== this.cTT) {
                        ...
                        q += p * m * (da ? 1 - h : h);
                        D -= u * m * (j ? da ? h : 1 - h : 1);
                        i && (q -= k * h * (u < 0 ? -1 : 1), j && (D -= l * h * (p < 0 ? -1 : 1)), H(b, {textAlign: g}));
                        this.xCorr = q;
                        this.yCorr = D
                    }
                    H(b, {left: e + q + "px", top: f + D + "px"});
                    this.cTT = aa
                }
            ...
            if (!a) {
                if (e.namespaceURI === pa || b.forExport) {
                    try {
                        a = e.getBBox ? r({}, e.getBBox()) : {width: e.offsetWidth, height: e.offsetHeight}
                    } catch (h) {
                    }
    ...
    ra.prototype = {
        Element: va, init: function (a, b, c, d) {
            var e = location, f;
            f = this.createElement("svg").attr({xmlns: pa, version: "1.1"});
            ...
            n(c, function (c, d) {
                ...
                n(h, function (c) {
                    if (c !== "" || h.length === 1) {
                        ...
                        f.test(c) && (z(o, "onclick", 'location.href="' + c.match(f)[1] + '"'), H(o, {cursor: "pointer"}));
                ...
                if (a) {
                    if (b = a.div, !b) {
                        ...
                        n(d.reverse(), function (a) {
                            var d;
                            b = a.div = a.div || Q(ia, {className: z(a.element, "class")}, {
                                position: "absolute",
            ...
            var m = this, p = m.g(i), u = m.text("", 0, 0, g).attr({zIndex: 1}), o, q, D = 0, aa = 3, Ga, v, F, y, P = 0, fb = {}, yb, g = p.attrSetters;
            I(p, "add", l);
            g.width = function (a) {
                Ga = a;
                return !1
            ...
            g.text = function (a, b) {
                ...
                o.attr(A({width: p.width, height: p.height}, fb));
                fb = null;
                j();
                return !1
            };
    ...
    if (!Z && !U) {
            ...
            init: function (a, b) {
                ...
                if (la(a))c = a, u = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight : this[c]; else for (c in a)if (d = a[c], m = !1, e = p[c] && p[c].call(this, d, c), e !== !1 && d !== null) {
                    ...
                    if (j && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c))k || (this.symbolAttr(a),
                        ...
                        g[c] = d;
                        m = !0
                    } else if (c === "zIndex")d && (g[c] = d), m = !0; else if (c === "width" || c === "height")d = y(0, d), this[c] = d, this.updateClipping ? (this[c] = d, this.updateClipping()) :
                        g[c] = d, m = !0; else if (c === "x" || c === "y")this[c] = d, g[{
                        x: "left",
                        y: "top"
                    ...
                    else if (h === "shape" && c === "rotation")this[c] = d, f.style.left = -s(Y(d * ab) + 1) + "px", f.style.top = s(V(d * ab)) + "px"; else if (c === "translateX" || c === "translateY" || c === "rotation")this[c] = d, this.updateTransform(), m = !0; else if (c === "text")this.bBox = null, f.innerHTML = d, m = !0;
                    m || (Qa ? f[c] = d : z(f, c, d))
                }
                return u
            }, clip: function (a) {
                ...
                a ? (c = a.members, c.push(b), b.destroyClip = function () {
                    Ba(c, b)
                }, e && e.className === "highcharts-tracker" && !Qa && H(d, {visibility: "hidden"}), a = a.getCSS(b)) : (b.destroyClip &&
                b.destroyClip(), a = {clip: Qa ? "inherit" : "rect(auto)"});
                return b.css(a)
                ...
                if (a) {
                    ...
                    for (e = 1; e <= 3; e++) {
                        ...
                        h = Q(g.prepVML(j), null, {
                            left: w(i.left) + o(a.offsetX, 1), top: w(i.top) +
                            o(a.offsetY, 1)
                        });
                        if (c)h.cutOff = l + 1;
        ...
        ja = ca(va, ja);
        var ha = {
            Element: ja, isIE8: Fa.indexOf("MSIE 8.0") > -1, init: function (a, b, c) {
                var d, e;
                this.alignedObjects = [];
                ...
                return r(e, {
                    ...
                    getCSS: function (a) {
                        ...
                        !b && Qa && a.element.nodeName !== "IMG" && r(c, {width: e + "px", height: f + "px"});
                        return c
                    },
                ...
                if (i) {
                    ...
                    if (c === "fill")if (i === "gradient")c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, p = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, t = 'angle="' + (90 - J.atan((m - a) / (p - c)) * 180 / xa) + '"', F(); else {
                ...
                } else if (g.test(a) && b.tagName !== "IMG")f = qa(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], Q(this.prepVML(h), null, null, b), j = f.get("rgb"); else {
                ...
                return a
            }, text: ra.prototype.html, path: function (a) {
    ...
    Pa.prototype = {
        addLabel: function () {
            ...
            b = a.labelFormatter.call({
                axis: a,
                chart: c, isFirst: i, isLast: j, dateTimeLabelFormat: l, value: a.isLog ? ea(ba(k)) : k
            });
            f = d && {width: y(1, s(d - 2 * (g.padding || 10))) + "px"};
            f = r(f, g.style);
            if (t(e))e && e.attr({text: b}).css(f); else {
                d = {align: g.align};
            ...
            var a = this.axis.options.labels,
                b = this.labelBBox.width, a = b * {left: 0, center: 0.5, right: 1}[a.align] - a.x;
            return [-a, b - a]
            ...
            if (l && q)t === "inside" && (q = -q), c.opposite && (q = -q), g = this.getMarkPath(P, r, q, l, f, e), m ? m.animate({d: g}) : this.mark = e.path(g).attr({
                stroke: D,
                "stroke-width": l
            }).add(c.axisGroup);
    ...
    nb.prototype = {
        render: function () {
            ...
            b.isLog && (j = ma(j),
                i = ma(i), l = ma(l));
            if (h) {
                if (u = b.getPlotLinePath(l, h), d = {stroke: q, "stroke-width": h}, m)d.dashstyle = m
            } else if (k) {
                if (j = y(j, b.min - d), i = O(i, b.max + d), u = b.getPlotBandPath(j, i, e), d = {fill: q}, e.borderWidth)d.stroke = e.borderColor, d["stroke-width"] = e.borderWidth
            } else return;
            if (t(D))d.zIndex = D;
            if (p)u ? p.animate({d: u}, null, p.onGetPath) : (p.hide(), p.onGetPath = function () {
                p.show()
    ...
    ob.prototype = {
        defaultOptions: {
            ...
            tickWidth: 1,
            title: {align: "middle", style: {color: "#6D869F", fontWeight: "bold"}},
            type: "linear"
        },
        defaultYAxisOptions: {
            endOnTick: !0,
        ...
        defaultLabelFormatter: function () {
            ...
            if (a.categories)f = b; else if (c)f = cb(c, b); else if (e && g >= 1E3)for (; e-- && f === x;)a = Math.pow(1E3, e + 1), g >= a && d[e] !== null && (f = Ia(b / a, -1) + d[e]);
            ...
            n(a.series, function (g) {
                if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        ...
                        u = g.processedYData;
                        s = u.length;
                        for (f = 0; f < s; f++)if (n = h[f], q = u[f], i && (w = (F = q < D) ? k : j, P = F ? p : l, q = w[n] = t(w[n]) ? ea(w[n] + q) : q, c[P] || (c[P] = {}), c[P][n] || (c[P][n] = new Hb(a, a.options.stackLabels, F, n, m, i)), c[P][n].setTotal(q)), q !== null && q !== x && (C && (q = g.modifyValue(q)), A || (h[f + 1] || n) >= z.min && (h[f - 1] || n) <= z.max))if (n = q.length)for (; n--;)q[n] !== null && (r[v++] = q[n]); else r[v++] = q;
                        if (!a.usePercentage && r.length)a.dataMin = O(o(a.dataMin, r[0]), Ma(r)), a.dataMax = y(o(a.dataMax, r[0]), Da(r));
                        if (t(D))if (a.dataMin >= D)a.dataMin = D, a.ignoreMinPadding = !0; else if (a.dataMax <
        ...
        getLogTickPositions: function (a, b, c, d) {
            ...
            if (a >= 0.5)a = s(a), g = this.getLinearTickPositions(a, b, c); else if (a >= 0.08)for (var f = T(b), h, i, j, k, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
                i = e.length;
        ...
        getOffset: function () {
            ...
            if (!a.axisGroup)a.gridGroup = c.g("grid").attr({zIndex: d.gridZIndex || 1}).add(), a.axisGroup = c.g("axis").attr({zIndex: d.zIndex || 2}).add(), a.labelGroup = c.g("axis-labels").attr({zIndex: p.zIndex || 7}).add();
            ...
            }), a.staggerLines && (u += (a.staggerLines - 1) * 16); else for (D in f)f[D].destroy(), delete f[D];
            if (m && m.text) {
        ...
        render: function () {
            ...
            if (o)q = a.getLinePath(o), a.axisLine ? a.axisLine.animate({d: q}) : a.axisLine = c.path(q).attr({
                stroke: d.lineColor,
                "stroke-width": o,
                zIndex: 7
            }).add(a.axisGroup),
        ...
        destroy: function () {
            ...
            r(f, {
                x: g ? (2 * f.x + a) / 3 : a, y: g ? (f.y + b) / 2 :
                    b, anchorX: g ? (2 * f.anchorX + c) / 3 : c, anchorY: g ? (f.anchorY + d) / 2 : d
            });
            e.label.attr(f);
            ...
            k === !1 || !i ? this.hide() : (this.isHidden && e.show(), e.attr({text: k}), m = f.borderColor || a.color || j.color || "#606060",
                e.attr({stroke: m}), e = (f.positioner || this.getPosition).call(this, e.width, e.height, {
                plotX: g,
                plotY: h
        ...
        normalizeMouseEvent: function (a) {
            ...
            if (d && this.options.tooltip.shared && (!g || !g.noSharedTooltip)) {
                ...
                for (i = 0; i < h; i++)if (c[i].visible &&
                    c[i].options.enableMouseTracking !== !1 && !c[i].noSharedTooltip && c[i].tooltipPoints.length)b = c[i].tooltipPoints[k], b._dist = L(k - b[c[i].xAxis.tooltipPosName || "plotX"]), j = O(j, b._dist), e.push(b);
            ...
            function a() {
                ...
                if (c)H(d, {cursor: "auto"}), c.cancelClick = e, c.mouseIsDown = e = !1;
            ...
            d.onclick = function (a) {
                ...
                }), E(d.series, "click", r(a, {point: d})), d.firePointEvent("click", a)) : (r(a, b.getMouseCoordinates(a)), c.isInsidePlot(a.chartX - c.plotLeft, a.chartY - c.plotTop) && E(c, "click", a))
            }
        }, destroy: function () {
    ...
    rb.prototype = {
        init: function (a) {
            ...
            f && d.align(r({width: g, height: h}, j), !0, b.spacingBox);
            ...
            if (d > 0)b !== x && ua(b, this.chart), this.nav.attr({
                ...
                fill: d ===
                1 ? f : g
            }).css({cursor: d === 1 ? "default" : "pointer"}), h.attr({text: d + "/" + this.pageCount}), this.down.attr({
                x: 18 + this.pager.getBBox().width,
                fill: d === c ? f : g
            }).css({cursor: d === c ? "default" : "pointer"}), this.scrollGroup.animate({translateY: -O(e * (d - 1), this.fullHeight - e + i) + 1}), h.attr({text: d + "/" + c}), this.currentPage = d
        }
    };
    sb.prototype = {
        initSeries: function (a) {
            ...
            if (!c)this.loadingDiv = c = Q(ia, {className: "highcharts-loading"}, r(d.style, {
                left: this.plotLeft + "px", top: this.plotTop + "px", width: this.plotWidth +
                "px", height: this.plotHeight + "px", zIndex: 10, display: R
            ...
            if (!this.loadingShown)H(c, {
                opacity: 0,
                display: ""
            }), xb(c, {opacity: d.style.opacity}, {duration: d.showDuration || 0}), this.loadingShown = !0
            ...
            b.series.length && f > O(e.dataMin, e.min) && c < y(e.dataMax, e.max) && b.setExtremes(f, c, !0, !1, {trigger: "pan"});
            this.mouseDownX = a;
            ...
            H(d.container, {width: e + "px", height: f + "px"});
    ...
    Ta.prototype = {
        init: function (a, b, c) {
            ...
            if (!(a === this.state || this.selected && a !== "select" || e[a] && e[a].enabled === !1 || a && (i || g && !h.enabled))) {
                ...
                {x: b - e, y: c - e, width: 2 * e, height: 2 * e} : {})); else {
    ...
    N.prototype = {
        ...
        generatePoints: function () {
            ...
            if (b && (g !== (c = b.length) || j))for (m = 0; m < c; m++)if (m === h && !j && (m += g), b[m])b[m].destroyElements(), b[m].plotX = x;
            this.data = b;
            this.points = l
        },
        translate: function () {
        ...
        drawPoints: function () {
            ...
            if (l.enabled || this._hasPointMarkers)for (f = b.length; f--;)if (g = b[f], d = g.plotX, e = g.plotY, k = g.graphic, i = g.marker || {}, a = l.enabled && i.enabled ===
                x || i.enabled, m = c.isInsidePlot(d, e, c.inverted), a && e !== x && !isNaN(e))if (a = g.pointAttr[g.selected ? "select" : ""], h = a.r, i = o(i.symbol, this.symbol), j = i.indexOf("url") === 0, k)k.attr({visibility: m ? Z ? "inherit" : "visible" : "hidden"}).animate(r({
                x: d - h,
                y: e - h
        ...
        getAttribs: function () {
            ...
            for (f =
                ...
                if (g.options)for (l in k)t(b[k[l]]) && (e = !0);
                if (e) {
                    b = b || {};
                    j = [];
                    c = b.states || {};
            ...
            if (b.enabled || a._hasPointLabels)a.dlProcessOptions && a.dlProcessOptions(b), g = a.plotGroup("dataLabelsGroup", "data-labels", a.visible ? "visible" : "hidden", 6), e = b, n(c, function (c) {
                ...
                if (j && !i)c.dataLabel = j.destroy(); else if (i) {
                    ...
                    b.style.color = o(b.color, b.style.color,
                        a.color, "black");
                    if (j)j.attr({text: f}), l = !1; else if (t(f)) {
                        j = {
                            fill: b.backgroundColor,
        ...
        alignDataLabel: function (a, b, c, d, e) {
            var f = this.chart, g = f.inverted, h = o(a.plotX, -999), a = o(a.plotY, -999), i = b.getBBox(),
                d = r({x: g ? f.plotWidth - a : h, y: s(g ? f.plotHeight - h : a), width: 0, height: 0}, d);
            r(c, {width: i.width, height: i.height});
            c.rotation ? (d = {
                align: c.align,
                x: d.x + c.x + d.width / 2,
                y: d.y + c.y + d.height / 2
            }, b[e ? "attr" : "animate"](d)) : (b.align(c, null, d), d = b.alignAttr);
            b.attr({visibility: c.crop === !1 || f.isInsidePlot(d.x, d.y) || f.isInsidePlot(h, a, g) ? Z ? "inherit" : "visible" : "hidden"})
        },
        ...
        drawGraph: function () {
            ...
            if (b)eb(b), b.animate({d: g}); else if (e) {
        ...
        drawTracker: function () {
            var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath),
                e = d.length, f = a.chart, g = f.renderer, h = f.options.tooltip.snap, i = a.tracker, j = b.cursor, j = j && {cursor: j}, k = a.singlePoints, l = this.isCartesian && this.plotGroup("trackerGroup", null, "visible", b.zIndex || 1, f.trackerGroup), m;
            ...
            i ? i.attr({d: d}) : a.tracker = g.path(d).attr({
                isTracker: !0,
    ...
    G = ca(N);
    $.line = G;
    W.area = A(ga, {threshold: 0});
    G = ca(N, {
        type: "area", getSegmentPath: function (a) {
            ...
            c ? c.animate({d: a}) : this.area = this.chart.renderer.path(a).attr({
                fill: o(b.fillColor,
                    qa(this.color).setOpacity(b.fillOpacity || 0.75).get()), zIndex: 0
            }).add(this.group)
    ...
    ha = ca(N, {
        ...
        translate: function () {
            ...
            n(l, function (c) {
                ...
                c.trackerArgs = L(j) < 3 && A(c.shapeArgs, {height: 6, y: i - 3})
            })
        },
        getSymbol: ya,
        ...
        drawPoints: function () {
            ...
            n(a.points, function (e) {
                ...
                if (f !== x && !isNaN(f) && e.y !== null)d = e.shapeArgs, g ? (eb(g), g.animate(A(d))) : e.graphic = c[e.shapeType](d).attr(e.pointAttr[e.selected ?
                    "select" : ""]).add(a.group).shadow(b.shadow, null, b.stacking && !b.borderRadius); else if (g)e.graphic = g.destroy()
            })
        },
        drawTracker: function () {
            var a = this, b = a.chart, c = b.renderer, d, e, f = +new Date, g = a.options, h = g.cursor, i = h && {cursor: h}, j = a.isCartesian && a.plotGroup("trackerGroup", null, "visible", g.zIndex || 1, b.trackerGroup), k, l, m;
            n(a.points, function (h) {
                ...
                if (h.y !== null && m)e ? e.attr(d) : h.tracker = c[h.shapeType](d).attr({
                    isTracker: f,
                    fill: wb, visibility: a.visible ? "visible" : "hidden"
    ...
    $.column = ha;
    W.bar = A(W.column);
    za = ca(ha, {type: "bar", inverted: !0});
    $.bar = za;
    W.scatter = A(ga, {
        lineWidth: 0, states: {hover: {lineWidth: 0}}, tooltip: {
    ...
    za = ca(N, {
        type: "scatter", sorted: !1, translate: function () {
            ...
            a._hasTracking ? a._hasTracking = !0 : a.markerGroup.attr({isTracker: !0}).on(fa ? "touchstart" : "mouseover",
                function (b) {
                    a.onMouseOver();
    ...
    ya = {
        ...
        animate: function () {
            ...
            n(a.points, function (b) {
                var c = b.graphic, b = b.shapeArgs, d =
                    -xa / 2;
                c && (c.attr({r: 0, start: d, end: d}), c.animate({
                    r: b.r,
                    start: b.start,
                    end: b.end
                }, a.options.animation))
        ...
        translate: function () {
            ...
            for (n = 0; n < r; n++) {
                ...
                q.shapeType = "arc";
                q.shapeArgs = {
                    x: f[0], y: f[1], r: f[2] / 2, innerR: f[3] / 2, start: h,
                    end: i
                };
                j = (i + h) / 2;
        ...
        drawPoints: function () {
            ...
            n(a.points, function (j) {
                ...
                e ? e.animate(i) : j.graphic = e = c.arc(i).setRadialReference(a.center).attr(r(j.pointAttr[""], {"stroke-linejoin": "round"})).add(j.group).shadow(g,
                    h);
            ...
            if (d.enabled || this._hasPointLabels) {
                ...
                21); y--;) {
                    ...
                    for (v = 0; v < C; v++) {
                        ...
                        g.attr({visibility: t, align: h[6]})[g.moved ? "animate" : "attr"]({
                            x: s + d.x + ({
                                left: e,
                                right: -e
                            }[h[6]] || 0), y: q + d.y - 10
                        ...
                        g.moved = !0;
                        if (p && f)g = b.connector, h = i ? ["M", s + (h[6] === "left" ? 5 : -5), q, "C", s, q, 2 * h[2] - h[4], 2 * h[3] - h[5], h[2], h[3], "L", h[4], h[5]] : ["M", s + (h[6] === "left" ? 5 : -5), q, "L", h[2], h[3], "L", h[4], h[5]], g ? (g.animate({d: h}), g.attr("visibility", t)) :
